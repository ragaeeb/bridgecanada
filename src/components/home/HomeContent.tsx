...
export function HomeContent({ cards, contactEmail }: HomeContentProps) {
    return (
        <div className="w-full items-center justify-center bg-black">
            ...
            <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 lg:grid-cols-3">
                <WobbleCard containerClassName="col-span-1 h-full min-h-[500px] bg-green-800 lg:col-span-2 lg:min-h-[300px]">
                    ...
                    <Image
                        alt="Passport"
                        className="-bottom-10 -right-4 lg:-right-[20%] absolute rounded-2xl object-contain"
                        height={500}
                        src="/passport.webp"
                        width={500}
                    />
                ...
                <WobbleCard containerClassName="col-span-1 min-h-[500px] bg-green-950 lg:col-span-3 lg:min-h-[600px] xl:min-h-[300px]">
                    ...
                    <Image
                        alt="Transportation"
                        className="-bottom-10 -right-10 md:-right-[40%] lg:-right-[10%] absolute rounded-2xl object-contain"
                        height={500}
                        src="/business-cards.jpg"
                        width={500}
                    />
                </WobbleCard>
                <WobbleCard containerClassName="col-span-1 min-h-[500px] bg-red-900 lg:col-span-3 lg:min-h-[600px] xl:min-h-[300px]">
                    <div className="max-w-sm">
                        <h2 className="max-w-sm text-balance text-left font-semibold text-base text-white tracking-[-0.015em] md:max-w-lg md:text-xl lg:text-3xl">
                            Dining
                        </h2>
                    ...
                    <Image
                        alt="Dining"
                        className="-bottom-25 -right-0 absolute rounded-2xl object-contain"
                        height={500}
                        src="/food.webp"
                        width={500}
                    />
                </WobbleCard>
                <WobbleCard containerClassName="col-span-1 h-full min-h-[500px] bg-emerald-800 lg:col-span-2 lg:min-h-[300px]">
                    <div className="max-w-xs">
                        <h2 className="text-balance text-left font-semibold text-base text-white tracking-[-0.015em] md:text-xl lg:text-3xl">
                            Accomodations
                        </h2>
                    ...
                    <Image
                        alt="Hotel Tag"
                        className="-bottom-10 -right-4 lg:-right-[0%] absolute rounded-2xl object-contain"
                        height={300}
                        src="/hotel_tag.webp"
                        width={200}
                    />
